...
make caption           # caption uncaptioned images
make train             # retrain SFT with full dataset
make rl                # GRPO with composite reward
make eval              # metrics + coverage report

# Full pipeline from scratch:
make generate N=5000   # render random samples
make caption           # describe them
make train             # SFT
make rl                # RL refinement
